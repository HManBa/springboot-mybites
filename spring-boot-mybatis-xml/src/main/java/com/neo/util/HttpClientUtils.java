...
public class HttpClientUtils {
	...
	/**
	 * 
	 * @Title: doGet @Description: 发送get请求；不带请求头和请求参数 @param url @param isHttps
	 * true=https false=http @return HttpClientResult 返回类型 @throws
	 */
	...
	public static HttpClientResult doPost(String url, Boolean isHttps) throws Exception {
		return doPost(url, null, null, isHttps, null);
	}
	...
	public static HttpClientResult doPost(String url, Map<String, String> params, Boolean isHttps) throws Exception {
		return doPost(url, null, params, isHttps, null);
	}
	 ...
	 * @throws Exception
	 */
	public static HttpClientResult doPost(String url, Map<String, String> params, Boolean isHttps, JSONObject jsonObj)
			throws Exception {
		return doPost(url, null, params, isHttps, jsonObj);
	}
	...
	public static HttpClientResult doPost(String url, Map<String, String> headers, Map<String, String> params,
			boolean isHttps, JSONObject jsonObj) throws Exception {
		// 创建httpClient对象
		CloseableHttpClient httpClient = HttpClients.createDefault();
		if (isHttps) {
			httpClient = getHttpClient();
	 ...
	 */
	public static void packageParam(JSONObject jsonObj, HttpEntityEnclosingRequestBase httpMethod)
			throws UnsupportedEncodingException {
		// 封装请求参数
		if (jsonObj != null) {
			StringEntity stringEntity = new StringEntity(jsonObj.toJSONString(), ENCODING);
			// 设置到请求的http对象中
